...
-Otu table
```{r}
otu.transferencia.2600.completa<-read.csv("/Users/ninamontoya/Desktop/Analisis.2022/analisisR/analisis.final/otutable.transferencia.completa.filterASVs.csv", check.names = F, row.names = 1)
```
...
###Metadata
```{r}
metadata.transferencia.2600.completo <- read.delim("/Users/ninamontoya/Desktop/Analisis.2022/analisisR/analisis.final/mapa.capII.transferencia.completo.txt", check.names = F) %>% 
